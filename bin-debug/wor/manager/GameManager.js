...
var GameManager = (function () {
    ...
    GameManager.prototype.startOldGame = function () {
        ...
        GlobalFun.wait(100).then(function () {
            _this.createEnter();
        });
    };
    //进入游戏
    GameManager.prototype.enterGame = function () {
        ...
        App.LayerManager.addChildToLayer(App.LayerManager.GAME_SCENE_LAYER, Tiled_Ground.getIns());
        ...
        // App.LayerManager.addChildToLayer(App.LayerManager.EFFECT_LAYER, RockBarContorller.instance);
        ...
        //启动主Render
        RenderManager.getIns().startRender();
    };
