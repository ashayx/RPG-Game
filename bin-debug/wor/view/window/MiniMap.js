...
var MiniMap = (function (_super) {
    ...
    MiniMap.prototype.initPanel = function () {
        ...
        texture.bitmapData = GameData.mapData.baseMap.bitmapData;
        this._mapBg.texture = texture;
        ...
        if (GameConfig.showRiver) {
            ...
            texture_1.bitmapData = GameData.mapData.riverMap.bitmapData;
            this._riverBg.texture = texture_1;
