    ...
    GameWindow.prototype.resize = function () {
        switch (this.__align) {
            ...
            case AlignType.TOP_CENTER:
                this.x = (App.UIAdapter.StageWidth - this.width * this.scaleX) / 2 + this.__offsetX;
                this.y = this.__offsetY;
                break;
            case AlignType.TOP_RIGHT:
                this.x = App.UIAdapter.StageWidth - this.width * this.scaleX + this.__offsetX;
                this.y = this.__offsetY;
                break;
            case AlignType.CENTER:
                this.x = (App.UIAdapter.StageWidth - this.width * this.scaleX) / 2 + this.__offsetX;
                this.y = (App.UIAdapter.StageHeight - this.height * this.scaleY) / 2 + this.__offsetY;
                break;
            case AlignType.BOTTOM_LEFT:
                this.x = this.__offsetX;
                this.y = App.UIAdapter.StageHeight - this.height * this.scaleY + this.__offsetY;
                break;
            case AlignType.BOTTOM_CENTER:
                this.x = this.x = (App.UIAdapter.StageWidth - this.width * this.scaleX) / 2 + this.__offsetX;
                this.y = App.UIAdapter.StageHeight - this.height * this.scaleY + this.__offsetY;
                break;
