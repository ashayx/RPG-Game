...
var Tiled_Ground = (function (_super) {
    ...
    Tiled_Ground.prototype.initWorld = function (worldW, worldH) {
        ...
        this.stageW = App.UIAdapter.StageWidth;
        this.stageH = App.UIAdapter.StageHeight;
        this.worldWidth = worldW;
        this.worldHeight = worldH;
        this.cf_X = this.worldWidth / GameData.mapData.baseMap.$bitmapWidth;
        this.cf_Y = this.worldHeight / GameData.mapData.baseMap.$bitmapHeight;
